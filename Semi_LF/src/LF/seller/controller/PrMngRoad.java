...
/**
 * Servlet implementation class PrMngRoad
 */
@WebServlet("/prMngRoad.prod")
public class PrMngRoad extends HttpServlet {
...
//						
						...
						// 게시판 리스트 조회해오기 (판매글 리스트 조회해오기)
//						JSONObject hashArr = pService.GsonList(currentPage, limit, sid);
						String hashArr = pService.GsonList(currentPage, limit, sid);
			...
			/*
			 * Gson gson = new Gson(); String jsonPlace1 = gson.toJson(list);
