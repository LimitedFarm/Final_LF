 ...
 * Generated at: 2019-10-31 09:01:53 UTC
...
public final class customerManagement_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(cuInfo.size() == 0) {
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td colspan=7>조회된 회원이 없습니다.</td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t");
} else { 
      out.write("\r\n");
...
for(Customer c : cuInfo) {
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>");
      out.print(c.getAddress2());
      out.write("&nbsp;");
      out.print(c.getAddress3() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>");
 ...
 for(int i=cuInfo.size(); i<10; i++) {
      ...
      out.print(request.getContextPath());
      out.write("/cuInfo.ad?currentPage=1\">FirstPage</a></li>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<!-- 이전 페이지로 -->\r\n");
      out.write("\t\t\t\t\t\t");
 if (currentPage <= 1) { 
 ...
 for(Customer c : cuInfo) { 
      out.write("\r\n");
      out.write("\t\t\t\t\t\tvar $tr = $(\"<tr>\");\r\n");
      out.write("\t\t\t\t\t\tvar $userCId = $(\"<td>\").text(\"");
      out.print(c.getCid());
      out.write("\");\r\n");
      out.write("\t\t\t\t\t\tvar $userId = $(\"<td>\").text(\"");
      out.print(c.getUserId());
      out.write("\");\r\n");
      out.write("\t\t\t\t\t\tvar $userName = $(\"<td>\").text(\"");
      out.print(c.getUserName());
      out.write("\");\r\n");
      out.write("\t\t\t\t\t\tvar $Address = $(\"<td>\").text(\"");
      out.print(c.getAddress2());
      out.write(' ');
      out.print(c.getAddress3());
      out.write("\");\r\n");
      out.write("\t\t\t\t\t\tvar $phone = $(\"<td>\").text(\"");
      out.print(c.getPhone());
      out.write("\");\r\n");
      out.write("\t\t\t\t\t\tvar $email = $(\"<td>\").text(\"");
      out.print(c.getEmail());
      out.write("\");\r\n");
      out.write("\t\t\t\t\t\tvar $joinDate = $(\"<td>\").text(\"");
      out.print(c.getJoinDate());
      out.write("\");\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t$tr.append($userCId);\r\n");
      out.write("\t\t\t\t\t\t$tr.append($userId);\r\n");
      out.write("\t\t\t\t\t\t$tr.append($userName);\r\n");
      out.write("\t\t\t\t\t\t$tr.append($Address);\r\n");
      out.write("\t\t\t\t\t\t$tr.append($phone);\r\n");
      out.write("\t\t\t\t\t\t$tr.append($email);\r\n");
      out.write("\t\t\t\t\t\t$tr.append($joinDate);\r\n");
 ...
 if(cuInfo.size() < 10){
      ...
      out.write("\t\t\t\t\t\t\t\t\t\tvar $tr = $(\"<tr>\");\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tvar $userCId = $(\"<td>\").text(data[key].cid);\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tvar $userId = $(\"<td>\").text(data[key].userId);\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tvar $userName = $(\"<td>\").text(data[key].userName);\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tvar $Address = $(\"<td>\").text(data[key].address2+\" \"+ data[key].address3);\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tvar $phone = $(\"<td>\").text(data[key].phone);\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tvar $email = $(\"<td>\").text(data[key].email);\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tvar $joinDate = $(\"<td>\").text(data[key].joinDate);\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t$tr.append($userCId);\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t$tr.append($userId);\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t$tr.append($userName);\r\n");
